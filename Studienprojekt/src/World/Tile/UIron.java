...
public class UIron extends Tile {

	public static String NAME = "Eisen";
	public static String PATH = "Resources/UndergroundTile/iron.png";
	...
	public static HashMap<Class, Integer> loot = new HashMap<Class, Integer>() {{
		put(Iron_ore.class, 100);
	}};
	
	public static Color color = new Color(157, 95, 64);
