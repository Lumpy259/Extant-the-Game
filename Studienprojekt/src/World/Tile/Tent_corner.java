...
public class Tent_corner extends Tile {

	public static String NAME = "Wand, Ecken, Zelt";
	public static String PATH = "Resources/Tiles/Tent_corner.png";
