...
public class UStone extends Tile {

	public static String NAME = "Stein";
	public static String PATH = "Resources/UndergroundTile/highstone.png";
	...
	public static Color color = new Color(90, 90, 90);
	
	public UStone(int id) {
