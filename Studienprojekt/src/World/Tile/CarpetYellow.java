...
public class CarpetYellow extends Tile {

	public static String NAME = "Boden";
	public static String PATH = "Resources/Tiles/carpet_yellow.png";
	...
	public static Color color = new Color(90, 70, 0);
	
	public CarpetYellow(int id) {
