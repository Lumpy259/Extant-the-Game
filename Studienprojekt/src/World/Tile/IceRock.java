...
public class IceRock extends Tile {

	public static String NAME = "Eisstein";
	public static String PATH = "Resources/Tiles/icerock.png";
	...
	public static Color color = new Color(180, 255, 255);
	
	public IceRock(int id) {
